...
//    incommingByte = incommingByte*100+50;
    ...
    pwm.writeMicroseconds(12, incommingByte);
   ...
   //##################################
    ...
    /*
  for (int i = 0; i <= 400; i++) {
     pwm.writeMicroseconds(11, incommingByte + perna - i );
      pwm.writeMicroseconds(4, incommingByte + perna - i );
      pwm.writeMicroseconds(5, incommingByte - pata + 3*i);
...
delay(1000);
 ...
 for (int i = 0; i <= 400; i++) {
     pwm.writeMicroseconds(1, incommingByte - perna + i );
      pwm.writeMicroseconds(14, incommingByte - perna + i );
       pwm.writeMicroseconds(0, incommingByte + pata - 3*i);
